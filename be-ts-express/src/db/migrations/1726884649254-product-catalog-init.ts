...
export class ProductCatalogInit1726884649254 implements MigrationInterface {
    name = 'ProductCatalogInit1726884649254'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`catalog_fields\` (\`id\` int NOT NULL, \`priceBest\` float NULL, \`priceSecond\` float NULL, \`priceTop5Avg\` float NULL, \`priceFull\` float NULL, \`positionFull\` tinyint NULL, \`positionMedalGold\` tinyint NULL, \`positionMedalPlatinum\` tinyint NULL, \`positionMedalLider\` tinyint NULL, \`positionOfficialStore\` tinyint NULL, \`length\` tinyint NULL, \`mlOwner\` tinyint NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
