...
export class ProductCatalogInit1728341636881 implements MigrationInterface {
    name = 'ProductCatalogInit1728341636881'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`search_fields\` (\`term\` varchar(255) NOT NULL, \`views\` int NULL, \`revenue\` float NULL, \`avgPrice\` float NULL, \`densityFull\` float NULL, \`densityLider\` float NULL, \`densityOfficialStore\` float NULL, \`densityGold\` float NULL, \`densityPlatinum\` float NULL, \`densityCatalog\` float NULL, \`densityGoodQualityThumbnail\` float NULL, \`densityVideo\` float NULL, \`densityGoodQualityPicture\` float NULL, \`densityFreeShipment\` float NULL, \`worstStar\` float NULL, PRIMARY KEY (\`term\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE \`search_fields\``);
