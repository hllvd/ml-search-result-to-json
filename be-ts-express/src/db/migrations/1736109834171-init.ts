...
export class Init1736109834171 implements MigrationInterface {
    name = 'Init1736109834171'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`search_position\` (\`position\` int NOT NULL, \`productId\` varchar(255) NOT NULL, \`metadataUpdatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`searchId\` int NULL, \`searchSearchTerm\` varchar(255) NULL, UNIQUE INDEX \`IDX_eb8fc9945d5ed4f0089ff3ff38\` (\`searchId\`, \`searchSearchTerm\`, \`position\`, \`productId\`), PRIMARY KEY (\`position\`, \`productId\`)) ENGINE=InnoDB`);
