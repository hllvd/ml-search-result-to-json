...
export class Init1736693772192 implements MigrationInterface {
    name = 'Init1736693772192'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`search_position\` (\`id\` int NOT NULL AUTO_INCREMENT, \`position\` int NOT NULL, \`metadataUpdatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`searchId\` int NULL, \`productId\` varchar(255) NULL, UNIQUE INDEX \`IDX_c683fb3bff2f6961728d12c8d0\` (\`searchId\`, \`position\`, \`productId\`), UNIQUE INDEX \`REL_c42dba2b59ca7c73d645a173a8\` (\`productId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`REL_c42dba2b59ca7c73d645a173a8\` ON \`search_position\``);
